...
open import Web.Semantic.DL.Interp using ( Interp ; Quotient ; ≈-sym ; ≈-trans )
...
cskolem-sound I (C ⊔ D) (Φ , Ψ) x  I✓ (inj₁ Fx) =
  inj₁ (cskolem-sound I C Φ x I✓ Fx)
cskolem-sound I (C ⊔ D) (Φ , Ψ) x  I✓ (inj₂ Gx) =
  inj₂ (cskolem-sound I D Ψ x I✓ Gx)
cskolem-sound I (∀[ R ] C) Φ x I✓ ∀RFx = 
  λ y xy∈R → cskolem-sound I C Φ y I✓ (∀RFx y (rskolem-complete I R x y I✓ xy∈R))
...
cskolem-sound I (≤1 R) Φ x I✓ ≤1Rx = 
  λ y z xy∈R xz∈R → ≈-trans I I✓ (≈-trans I (≤1Rx y z (rskolem-complete I R x y I✓ xy∈R) (rskolem-complete I R x z I✓ xz∈R)) (≈-sym I I✓))
