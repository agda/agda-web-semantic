...
⟦⟧₁-resp-≈ I (¬ C)      x∉⟦C⟧               x≈y = λ y∈⟦C⟧ → x∉⟦C⟧ (⟦⟧₁-resp-≈ I C y∈⟦C⟧ (≈-sym I x≈y))
⟦⟧₁-resp-≈ I (∀[ R ] C) x∈⟦∀RC⟧             x≈y = λ z yz∈⟦R⟧ → x∈⟦∀RC⟧ z (⟦⟧₂-resp-≈ I R x≈y yz∈⟦R⟧ (≈-refl I))
⟦⟧₁-resp-≈ I (∃⟨ R ⟩ C) (z , xz∈⟦R⟧ , z∈⟦C⟧) x≈y = (z , ⟦⟧₂-resp-≈ I R (≈-sym I x≈y) xz∈⟦R⟧ (≈-refl I) , z∈⟦C⟧)
⟦⟧₁-resp-≈ I (≤1 R)     x∈⟦≤1R⟧≈             x≈y = λ w z yw∈⟦R⟧ yz∈⟦R⟧ → x∈⟦≤1R⟧≈ w z (⟦⟧₂-resp-≈ I R x≈y yw∈⟦R⟧ (≈-refl I)) (⟦⟧₂-resp-≈ I R x≈y yz∈⟦R⟧ (≈-refl I))
⟦⟧₁-resp-≈ I ⊥          ()                  x≈y
